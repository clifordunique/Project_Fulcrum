...
public class SceneNodeGraph : EditorWindow 
{
	static SceneNodeGraph sceneNodeGraph;
	Rect window1;
	Rect window2;

	[MenuItem("Window/ProjectFulcrum/Conversation Editor")]
	static void Do()
	{
		sceneNodeGraph = GetWindow<SceneNodeGraph>();
		sceneNodeGraph.Init();
	}
